...
public partial class LanguageParser
{
    ...
    private ClauseDispatcher CreateDispatcher()
    {
        return new ClauseDispatcher()
            ...
            .On(nameof(HandleStartIsosurfaceClause), HandleStartIsosurfaceClause)
            .On(nameof(HandleStartParametricClause), HandleStartParametricClause)
            .On(nameof(HandleStartPatchClause), HandleStartPatchClause)
            .On(nameof(HandleStartBilinearPatchClause), HandleStartBilinearPatchClause)
            .On(nameof(HandleStartExtrusionClause), HandleStartExtrusionClause)
            .On(nameof(HandleStartTaperedExtrusionClause), HandleStartTaperedExtrusionClause)
            ...
            .On(nameof(HandleStartFieldClause), HandleStartFieldClause)
            ...
            .On(nameof(HandleStartPrimitiveClause), HandleStartPrimitiveClause)
            .On(nameof(HandleStartCallClause), HandleStartCallClause)
            ...
            .On(nameof(HandleStartForClause), HandleStartForClause)
            .On(nameof(HandleStartSurfaceIfClause), HandleStartSurfaceIfClause)
