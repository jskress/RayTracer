...
public abstract class BandPattern : Pattern
{
    ...
    /// <summary>
    /// A band is a unit wide, so a unit is the whole of its detail.  Anything finer than this in a
    /// picture is past what a pixel can hold, and is averaged over the patch a ray covers rather
    /// than sampled at its middle -- see <see cref="Pattern.Evaluate"/>.
    /// </summary>
