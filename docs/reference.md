...
| `taper` | How much a tapered extrusion's outline is scaled by at its top. | [Advanced Surfaces](advanced-surfaces.md#tapered-extrusion) |
| `tapered` | Surface: an extrusion whose outline is scaled as it rises. | [Advanced Surfaces](advanced-surfaces.md#tapered-extrusion) |
