...
public class TestPlanes
{
    ...
    {
        Plane plane = new ();
        Vector n1 = plane.SurfaceNormalAt(Point.Zero, null);
        Vector n2 = plane.SurfaceNormalAt(new Point(10, 0, -10), null);
        Vector n3 = plane.SurfaceNormalAt(new Point(-5, 0, 150), null);
