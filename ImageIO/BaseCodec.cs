...
public abstract class BaseCodec : IImageCodec
{
    ...
    public abstract void Encode(RenderContext context, Canvas canvas, Stream stream, ImageInformation info);
    ...
    public abstract Canvas[] Decode(RenderContext context, Stream stream);
}
