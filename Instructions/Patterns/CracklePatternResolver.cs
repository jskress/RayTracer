...
/// <summary>
/// This class is used to resolve a crackle pattern value.
/// </summary>
public class CracklePatternResolver : PatternResolver<CracklePattern>
{
    /// <summary>
    ...
    protected override void SetProperties(RenderContext context, Variables variables, CracklePattern value)
    {
